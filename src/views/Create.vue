<template>
	<div class="max-w-screen-md mx-auto px-4 py-10">
		...
		<div class="p-8 flex items-start bg-light-grey rounded-md shadow-lg">
			...
			>
				<h1 class="text-2xl text-at-light-green">Workout 기록하기</h1>
				...
				<div class="flex flex-col">
					...
					<select
						...
						v-model="workoutType"
					>
						<option value="select-workout">Workout 선택하기</option>
						<option value="strength">Strength 트레이닝</option>
